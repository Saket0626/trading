...
export const level1Quizzes: Record<string, QuizQuestion[]> = {
  ...
  "level-1-exam": [
    { id: "e1", question: "Which is a function of money?", options: ["Making profits", "Medium of exchange", "Guaranteeing returns", "Eliminating risk"], correctIndex: 1, explanation: "Money functions as medium of exchange, store of value, and unit of account." },
    { id: "e2", question: "What mainly determines money's value?", options: ["Only government", "Supply, demand, and trust", "Stock market", "Banks only"], correctIndex: 1, explanation: "Money's value comes from supply, demand, and trust in the system." },
    { id: "e3", question: "When demand is high and supply is low, price typically:", options: ["Falls", "Stays same", "Rises", "Is set by government"], correctIndex: 2, explanation: "High demand and low supply push prices up." },
    { id: "e4", question: "What is a market?", options: ["Only a stock exchange", "Where buyers and sellers trade", "A government agency", "A type of currency"], correctIndex: 1, explanation: "A market is any place where buyers and sellers come together to trade." },
    { id: "e5", question: "Intrinsic value is best described as:", options: ["Current market price", "An estimate of fundamental worth", "Same as market value", "What you paid"], correctIndex: 1, explanation: "Intrinsic value is estimated fundamental worth; market value is current price." },
    { id: "e6", question: "Investors typically hold for:", options: ["Minutes", "Hours", "Days", "Years or decades"], correctIndex: 3, explanation: "Investors hold long-term; traders hold shorter periods." },
    { id: "e7", question: "Which is a reason people trade?", options: ["Guaranteed profit", "Income, speculation, or hedging", "Only hedging", "Only speculation"], correctIndex: 1, explanation: "People trade for income, speculation, or hedging—not guaranteed profit." },
    { id: "e8", question: "A swing trader typically holds for:", options: ["Seconds", "Same day only", "Days to weeks", "Years"], correctIndex: 2, explanation: "Swing traders hold days to weeks." },
    { id: "e9", question: "Realistic annual return for many professional traders is often:", options: ["100%", "50%", "10–20%", "5% or less only"], correctIndex: 2, explanation: "Many pros target 10–20% annually; higher claims are often unrealistic." },
    { id: "e10", question: "Can you lose money when trading?", options: ["No, if careful", "Yes—every trade has risk", "Only in forex", "Only in crypto"], correctIndex: 1, explanation: "Every trade carries risk of loss." },
    { id: "e11", question: "When you buy a stock, who is on the other side?", options: ["The company", "Another trader selling", "The government", "Nobody"], correctIndex: 1, explanation: "Every trade has a buyer and a seller." },
    { id: "e12", question: "Which market is typically open 24/5?", options: ["US stocks only", "Forex", "Commodities only", "None"], correctIndex: 1, explanation: "Forex is open 24 hours, 5 days a week." },
    { id: "e13", question: "Commodities include:", options: ["Only stocks", "Gold, oil, agricultural products", "Only currencies", "Only crypto"], correctIndex: 1, explanation: "Commodities are physical goods: metals, energy, agriculture." },
    { id: "e14", question: "Crypto markets typically trade:", options: ["9–5 only", "24/5", "24/7", "Weekdays only"], correctIndex: 2, explanation: "Crypto markets run 24/7." },
    { id: "e15", question: "In trading, 'risk' means:", options: ["Guaranteed profit", "The possibility of losing money", "A fee", "A type of order"], correctIndex: 1, explanation: "Risk is the chance of loss." },
    { id: "e16", question: "A 1:2 risk-reward ratio means:", options: ["Risk $2 to make $1", "Risk $1 to make $2", "Win 1 of 2 trades", "Lose 2 and win 1"], correctIndex: 1, explanation: "You risk one unit to make two—so winners are larger than losers." },
    { id: "e17", question: "What is a stop loss?", options: ["A profit target", "A predetermined exit price to limit loss", "A fee", "A market type"], correctIndex: 1, explanation: "A stop loss caps your loss at a set price." },
    { id: "e18", question: "Studies suggest what share of retail traders lose money?", options: ["Under 10%", "About 30%", "About 50%", "Around 70–90%"], correctIndex: 3, explanation: "Many studies indicate 70–90% of retail traders lose money." },
    { id: "e19", question: "Paper trading uses:", options: ["Real money only", "Simulated money, no real cash at risk", "Only stocks", "Borrowed money"], correctIndex: 1, explanation: "Paper trading is practice with simulated money." },
    { id: "e20", question: "What money should you use for trading?", options: ["Rent or bill money", "Only money you can afford to lose", "Borrowed money", "Emergency fund"], correctIndex: 1, explanation: "Only use risk capital—money you can afford to lose." },
    { id: "e21", question: "Choosing your first market should consider:", options: ["Only popularity", "Capital, time, interest, regulation", "Only crypto", "Only stocks"], correctIndex: 1, explanation: "Consider capital, schedule, interest, and regulation." },
    { id: "e22", question: "Demo accounts are usually:", options: ["Paid only", "Free from most brokers", "Only for a week", "Only for forex"], correctIndex: 1, explanation: "Most brokers offer free demo accounts." },
    { id: "e23", question: "What should you learn first?", options: ["Only strategies", "Foundations: money, markets, risk", "Only options", "Only technical analysis"], correctIndex: 1, explanation: "Build foundations before strategies." },
    { id: "e24", question: "'Averaging down' means:", options: ["Taking profits", "Adding to a losing position hoping it recovers", "Using a stop loss", "Paper trading"], correctIndex: 1, explanation: "Averaging down is adding to a loser—often dangerous." },
    { id: "e25", question: "To unlock Level 2, you must pass the Level 1 Final Exam with:", options: ["50%", "60%", "70%", "80%"], correctIndex: 3, explanation: "80% (20/25) is required to unlock Level 2." },
  ],
};

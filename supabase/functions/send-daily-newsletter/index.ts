...
<body style="font-family: system-ui, sans-serif; line-height: 1.6; color: #111; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <p style="margin-top: 24px;">
    <a href="${siteUrl}/learn" style="display: inline-block; padding: 12px 24px; background: #00D4AA; color: #0A0D12; text-decoration: none; font-weight: 600; border-radius: 8px;">Continue Learning</a>
  </p>
